...
the boolean constants \textit{true} and \textit{false},
conditional expressions, the numeric constant \textit{0},
the arithmetic operators \textit{succ} and \textit{pred},
and testing operation \textit{iszero}
that returuns \textit{true} if its argument is \textit{0} and \textit{false} otherwise.
These forms can be summarized compatctly by the following grammar:
